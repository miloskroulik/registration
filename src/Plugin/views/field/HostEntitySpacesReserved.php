 ...
 *
 * @ViewsField("host_entity_spaces_reserved")
 */
class HostEntitySpacesReserved extends FieldPluginBase {
   ...
   * {@inheritdoc}
   */
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition): HostEntitySpacesReserved {
  ...
  public function render(ResultRow $values) {
    if ($entity = $this->getEntity($values)) {
      ...
      if ($host_entity->isConfiguredForRegistration()) {
        $build = [
          '#markup' => $host_entity->getActiveSpacesReserved(),
        ];

...
/**
 * Views argument plugin to extract the host entity ID from a URL.
 *
 * @ViewsArgumentDefault(
 *   id = "registration_host_entity_id",
 *   title = @Translation("Host entity ID from URL")
 * )
 */
class HostEntityId extends ArgumentDefaultPluginBase implements CacheableDependencyInterface {
